...
public enum SopDVRDefaultWires {
	...
	@Soplet( 
		parent=SopDVRPlugs.NULL,
		plug=SopDVRPlugs.desktop)
	desktop,

	@Soplet( 
		parent=SopDVRPlugs.NULL,
		plug=SopDVRPlugs.footerLeft)
	footerLeft,

	@Soplet( 
		parent=SopDVRPlugs.NULL,
		plug=SopDVRPlugs.footerRight)
	footerRight,

	@Soplet( 
		parent=SopDVRPlugs.NULL,
		plug=SopDVRPlugs.topRight)
	topRight,
...
//	createNews,
	...
	@Soplet( 
		parent=SopDVRPlugs.desktop,
		plug=SopDVRPlugs.displayAnnouncement)
	displayAnnouncement,
...
//	
	@Soplet( 
		parent=SopDVRPlugs.footerLeft,
		plug=SopDVRPlugs.userStatus,
		textEN="User status")
	userStatus,

	@Soplet( 
		parent=SopDVRPlugs.footerRight,
		plug=SopDVRPlugs.btnLogout,
		textEN="Logout")
	btnLogout,
