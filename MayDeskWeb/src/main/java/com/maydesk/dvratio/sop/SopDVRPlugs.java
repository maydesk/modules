...
import com.maydesk.base.gui.PDNewButton;
...
public enum SopDVRPlugs {
	...
	@Soplet(
		plugTitle="",
		plugType=SopSocketType.base)		
	NULL,

	@Soplet(
		plugTitle="Desktop",
		plugType=SopSocketType.desktop)		
	desktop,

	@Soplet(
		plugTitle="Footer Left",
		plugType=SopSocketType.panel)		
	footerLeft,

	@Soplet(
		plugTitle="Footer Right",
		plugType=SopSocketType.panel)		
	footerRight,
...
//	createButton,
	...
	@Soplet(
		plugTitle="Recycle Bin",
		plugType=SopSocketType.panel,
		editorClass=PDRecycleBin.class)		
	recycleBin,
...
//	createNews,
	...
	@Soplet(
		plugTitle="Display Announcement",		
		plugType=SopSocketType.panel,
		editorClass=PnlAnnouncement.class)
	displayAnnouncement,

	@Soplet(
		plugTitle="Show user admin",		
		plugType=SopSocketType.action,
		editorClass=FrmUsers.class)
	openFrmUser,

	@Soplet(
		plugTitle="User status",		
		plugType=SopSocketType.panel,
		editorClass=PnlUserStatus.class)
	userStatus,

	@Soplet(
		plugTitle="User status",		
		plugType=SopSocketType.panel,
		editorClass=BtnLogout.class)
	btnLogout,
