...
public class MDImageService implements Service {
	 ...
	 * 
	 * @param userInstance
	 *            the relevant application user instance
	 * @param imageId
	 ...
	 * 
	 * @param conn
	 *            the <code>Connection</code> on which to render the image
	 ...
	 * 
	 * @param conn
	 *            the <code>Connection</code> to which the image should be
	 *            rendered
	 * @param imageReference
	 *            the image to render
	 * @throws IOException
	...
	private void renderStreamImage(Connection conn, ImageReference imageReference) throws IOException {
		try {
			...
			// Internet Explorer appears to enjoy making half-hearted requests
			// for images, wherein it resets the connection
			// leaving us with an IOException. This exception is silently eaten.
			// It would preferable to only ignore SocketExceptions, however the
			// API documentation does not provide
	 ...
	 * 
	 * @param userInstance
	 *            the <code>UserInstance</code> from which the image was
	 *            requested
	 * @param imageId
	 *            the id of the image
