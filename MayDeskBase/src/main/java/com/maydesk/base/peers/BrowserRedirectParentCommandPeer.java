...
public class BrowserRedirectParentCommandPeer extends AbstractCommandSynchronizePeer {
    ...
    private static final Service BROWSER_REDIRECT_PARENT_SERVICE = JavaScriptService.forResource("Echo.BrowserRedirectParent", 
    		PDUtil.BASE_PATH + "js/PDBrowserRedirectParent.js");
